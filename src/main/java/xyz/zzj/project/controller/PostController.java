...
import xyz.zzj.project.model.entity.Post;
import xyz.zzj.project.model.entity.User;
import xyz.zzj.project.service.PostService;
...
public class PostController {
     ...
     */
    @PostMapping("/add")
    public BaseResponse<Long> addPost(@RequestBody NyApiInterfaceAddRequest postAddRequest, HttpServletRequest request) {
     ...
     */
    @PostMapping("/update")
    public BaseResponse<Boolean> updatePost(@RequestBody NyApiInterfaceUpdateRequest postUpdateRequest,
    ...
    @GetMapping("/list")
    public BaseResponse<List<Post>> listPost(NyApiInterfaceQueryRequest postQueryRequest) {
    ...
    public BaseResponse<Page<Post>> listPostByPage(NyApiInterfaceQueryRequest postQueryRequest, HttpServletRequest request) {
        if (postQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        Post postQuery = new Post();
